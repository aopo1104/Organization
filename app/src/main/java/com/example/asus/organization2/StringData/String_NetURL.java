...
public class String_NetURL {
    ...
    public static final String WEBSITEONLINE="http://10.0.2.2:8888/organization/public/index.php/index/";//这是模拟器调试用的
//    public static final String WEBSITEONLINE="http://192.168.1.106:8080/organization/public/index.php/index/"; //这是真机调试用到的
//    public static final String WEBSITEONLINE="http://www.proger.cn/organization/public/index.php/index/"; //这是服务器数据库用到的
//public static final String WEBSITEONLINE="http://www.baidu.com/";
