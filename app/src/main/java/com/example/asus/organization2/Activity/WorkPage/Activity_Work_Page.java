...
public class Activity_Work_Page extends Activity_Base implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    RelativeLayout layout_workPage_activityPublish,layout_workPage_taskPublish,layout_workPage_onduty,layout_workPage_workPlan,layout_workPage_dayReport;
    ...
    private void init(){
        ...
        layout_workPage_dayReport = findViewById(R.id.layout_workPage_dayReport);
        ...
        layout_workPage_dayReport.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.layout_workPage_onduty:   //值班签到
                ...
                startActivity(intent);
                break;
            case R.id.layout_workPage_dayReport:
                intent = new Intent(mContext,Activity_reportCreate.class);
                startActivity(intent);
                break;
            case R.id.layout_workPage_workPlan: //工作安排
