...
import com.example.asus.organization2.BuildConfig;
                ...
                case CODE_GALLERY_REQUEST:
                    if (hasSdcard()) {
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                            newUri = FileProvider.getUriForFile(this, "com.example.asus.organization2.FileProvider", new File(newUri.getPath()));
                        }
